  ...
  return (
    <SingUpContainer>
      <form onSubmit={sendCadastro}>
        <MyWalletLogo />
        <input placeholder="Nome" type="text" id="name" required value={name} onChange={e => setName(e.target.value)} />
        ...
        <input placeholder="Confirme a senha" type="password"  value={passwordCheck} onChange={e => setPasswordCheck(e.target.value)} />
